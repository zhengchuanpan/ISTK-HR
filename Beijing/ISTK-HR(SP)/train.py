...
parser.add_argument('--model_file', default = '../data/ISTK-HR(SP)', type = str)
parser.add_argument('--log_file', default = '../data/log_train(SP)', type = str)
...
(train_x_gp, train_gp, train_TE, train_y, val_x_gp, val_gp, val_TE, val_y,
 test_x_gp, test_gp, test_TE, test_y) = utils.load_data(args)
...
x_gp, gp, TE, label = model.placeholder(args.h)
pred = model.model(x_gp, gp, TE, args.T, args.d, mean, std)
