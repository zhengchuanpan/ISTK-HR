...
parser.add_argument('--model_file', default = '../data/ISTK-HR', type = str)
...
for epoch in range(args.epochs):
    ...
    # val loss
    val_loss = []
    num_val = val_x_gp_fw.shape[1] // args.h
    t1 = time.time()
    for i in range(num_val):
        feed_dict = {
            x_gp_fw: val_x_gp_fw[:, i * args.h : (i + 1) * args.h],
            x_gp_bw: val_x_gp_bw[:, i * args.h : (i + 1) * args.h],
